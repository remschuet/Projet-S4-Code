...
HD_PWD='C:/s4projetVivado/uart/uart.runs/uart_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_proc_sys_reset_0_0.tcl
